...
//
//public class ParametricFunctionGuidingVectorField extends Follower {
//
...
//
//    public ParametricFunctionGuidingVectorField() {}
//
//    public ParametricFunctionGuidingVectorField(LinearOpMode opMode) { this.opMode = opMode; }
//    public ParametricFunctionGuidingVectorField(OpModePipeline opMode) {
//        this.opMode = opMode;
//    }
//
...
//            y[i] = p.y;
//        }
//        xSpline = interpolator.interpolate(t, x);
//        ySpline = interpolator.interpolate(t, y);
//
...
//        UnivariatePointValuePair minValue = optim.optimize(new MaxEval(1000), new UnivariateObjectiveFunction(distance), GoalType.MINIMIZE, new SearchInterval(0, 1));
//
//        double xDerivative = xSpline.derivative().value(minValue.getPoint());
//        double yDerivative = ySpline.derivative().value(minValue.getPoint());
...
//        Vector crossTrackVec = new Vector(xSpline.value(minValue.getPoint()) - robotPose.getX(), ySpline.value(minValue.getPoint()) - robotPose.getY()).multiply(CROSS_TRACK_ERROR_GAIN);
//
